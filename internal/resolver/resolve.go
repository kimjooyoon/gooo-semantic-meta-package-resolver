...
func ValidateContract(contract Source) error {
	if contract.Schema != "gooo/contract/semantic_meta_package_resolver/source/v1" || contract.Kind != "contract" || contract.Name != "semantic_meta_package_resolver" || contract.LanguageVersion != "v1" {
